<script>
  ...
  metatags.title = 'Fluffy - TAU Orange-Limonade🍊'
    ...
    <div class="pt-6">
      ...
      <div class="relative max-w-2xl mx-auto mt-6 sm:px-6 lg:max-w-7xl lg:px-8 lg:grid lg:grid-cols-3 lg:gap-x-8 lg:left-64">
        <div class="aspect-w-4 aspect-h-5 sm:rounded-lg sm:overflow-hidden lg:aspect-w-3 lg:aspect-h-4">
          <img src="/img/limo6.png" alt="TAU Orange-Limonade" class="object-cover object-center w-full h-full">
        </div>
      </div>
      ...
      <div class="max-w-2xl mx-auto pt-10 pb-16 px-4 sm:px-6 lg:max-w-7xl lg:pt-16 lg:pb-24 lg:px-8 lg:grid lg:grid-cols-3 lg:grid-rows-[auto,auto,1fr] lg:gap-x-8">
        ...
        <div class="mt-4 lg:mt-0 lg:row-span-3">
          <p class="text-3xl text-gray-900">8,99€</p>
        </div>
