...
<footer class="bg-gradient-to-r from-yellow-300 via-orange-400 to-red-500">
    ...
    <div class="container pb-4 mx-auto">
        ...
        <a href="https://github.com/Luca180405/fluffy-limonadenfabrik" class="text-gray-700 transition-colors duration-200 hover:text-gray-900 dark:hover:text-white hover:animate-pulse">
        ...
        <a href="https://amazon.com" class="text-gray-700 transition-colors duration-200 hover:text-gray-900 dark:hover:text-white hover:animate-pulse">
        ...
        <a href="https://facebook.com" class="text-gray-700 transition-colors duration-200 hover:text-gray-900 dark:hover:text-white hover:animate-pulse">
